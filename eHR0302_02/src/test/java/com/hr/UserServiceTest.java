...
public class UserServiceTest {
	...
	public void setUp() {
		users = Arrays.asList(
				new User("j01_124", "이상무01", "1234", Level.BASIC, MIN_LOGINCOUNT_FOR_SILVER - 1, 0, "jamesol@paran.com",
						"2019/08/23"),
				new User("j02_124", "이상무02", "1234", Level.BASIC, MIN_LOGINCOUNT_FOR_SILVER, 0, "jamesol@paran.com",
						"2019/08/23") // BASIC -> SILVER
				,
				new User("j03_124", "이상무03", "1234", Level.SILVER, 50, MIN_RECCOMEND_FOR_GOLD - 1, "jamesol@paran.com",
						"2019/08/23"),
				new User("j04_124", "이상무04", "1234", Level.SILVER, 50, MIN_RECCOMEND_FOR_GOLD, "jamesol@paran.com",
						"2019/08/23") // SILVER -> GOLD
	...
	static public  class TestUserServiceImple extends UserServiceImpl {
		private String id = "j04_124";

		public TestUserServiceImple() {}
